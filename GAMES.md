...
| Cyber Hopper | [`games/cyber-hopper/`](games/cyber-hopper/) | reflex-timing | BUILT — active registry, deterministic replay and score validation verified; Phase 5.5B1 controlled Cyber Hopper authority trial passed staging acceptance and trial template is disabled; [acceptance evidence](docs/PHASE_5_5B1_CYBER_HOPPER_ACCEPTANCE.md) |
