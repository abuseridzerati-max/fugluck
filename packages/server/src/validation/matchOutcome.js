export function determineMatchOutcome(a, b) {
    const aTrusted = a !== null && a.verdict !== "invalid";
    const bTrusted = b !== null && b.verdict !== "invalid";
    if (a === null && b === null)
        return { a: "void", b: "void" };
    if (a === null)
        return bTrusted ? { a: "loss", b: "win" } : { a: "void", b: "void" };
    if (b === null)
        return aTrusted ? { a: "win", b: "loss" } : { a: "void", b: "void" };
    ...
    if (a.correctCount !== undefined && b.correctCount !== undefined) {
        ...
        if (a.totalResponseTicks !== undefined && b.totalResponseTicks !== undefined) {
            if (a.totalResponseTicks < b.totalResponseTicks)
                return { a: "win", b: "loss" };
            if (a.totalResponseTicks > b.totalResponseTicks)
                return { a: "loss", b: "win" };
        }
...
export function determineDisconnectOutcome(opponent) {
    if (opponent === null)
        return { a: "loss", b: "win" };
