...
function drawRoundedRect(ctx, x, y, w, h, r, fillColor, strokeColor, lineWidth = 1) {
    ctx.beginPath();
...
export function renderTFSprint(ctx, engine) {
    ...
    let trueFill = PALETTE.cardBg;
    let trueBorder = "#10b981";
    let falseFill = PALETTE.cardBg;
