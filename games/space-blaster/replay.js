import { SpaceBlasterEngine } from "./engine";
export const spaceBlasterReplayAdapter = {
    createEngine(seed) {
    ...
    applyAction(input, action) {
        ...
        else if (action === "moveUpDown")
            input.moveUp = true;
        else if (action === "moveUpUp")
            input.moveUp = false;
        else if (action === "moveDownDown")
            input.moveDown = true;
        else if (action === "moveDownUp")
            input.moveDown = false;
        else if (action === "shootPressed")
