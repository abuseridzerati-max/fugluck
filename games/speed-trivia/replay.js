...
export const speedTriviaReplayAdapter = {
    createEngine(seed) {
    ...
    applyAction(input, action) {
        if (action === "selectOption0")
            input.selectOption = 0;
        else if (action === "selectOption1")
            input.selectOption = 1;
        else if (action === "selectOption2")
            input.selectOption = 2;
        else if (action === "selectOption3")
            input.selectOption = 3;
        else
            return false;
        return true;
    },
